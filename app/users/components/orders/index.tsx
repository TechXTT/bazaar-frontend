      ...
      <div className="flex w-full flex-col items-center">
        <div className="flex w-full mb-4">
          <h2
            ...
            className={`text-2xl cursor-pointer font-bold ml-auto mr-auto ${
              filter === "receiving" && "underline underline-offset-2"
            }`}
          >
            Receiving
          </h2>
          <h2
            ...
            className={`text-2xl cursor-pointer font-bold ml-auto mr-auto ${
              filter === "sending" && "underline underline-offset-2"
            }`}
          >
            Sending
          </h2>
